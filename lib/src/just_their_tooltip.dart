...
import 'package:just_their_tooltip/just_their_tooltip.dart';
import 'package:just_their_tooltip/src/models/just_their_tooltip_trigger_mode.dart';
import 'package:just_their_tooltip/src/models/target_information.dart';
import 'package:just_their_tooltip/src/positioned_tooltip.dart';

part 'just_their_tooltip_entry.dart';
...
class JustTheirTooltip extends StatefulWidget implements JustTheirInterface {
  const JustTheirTooltip({
    Key? key,
    ...
    this.tailBuilder = JustTheirInterface.defaultTailBuilder,
    this.animatedTransitionBuilder =
        JustTheirInterface.defaultAnimatedTransitionBuilder,
  ...
  @override
  final JustTheirController? controller;
  ...
  @override
  final JustTheirTooltipTriggerMode? triggerMode;
  ...
  @override
  _JustTheirTooltipOverlayState createState() => _JustTheirTooltipOverlayState();
}

class _JustTheirTooltipOverlayState extends _JustTheirTooltipState<OverlayEntry> {
  @override
  OverlayEntry? entry;
...
abstract class _JustTheirTooltipState<T> extends State<JustTheirInterface>
  ...
  static const JustTheirTooltipTriggerMode _defaultTriggerMode =
      JustTheirTooltipTriggerMode.longPress;
  ...
  late JustTheirTooltipTriggerMode triggerMode;
  ...
  late JustTheirController _controller;
  ...
  void initState() {
    ...
    _controller = widget.controller ?? JustTheirController();
  ...
  void _attachController(JustTheirController controller) {
    controller.attach(
  ...
  @override
  void didUpdateWidget(covariant JustTheirInterface oldWidget) {
  ...
  Future<void> _handlePress() async {
    ...
    if (tooltipCreated && enableFeedback) {
      if (triggerMode == JustTheirTooltipTriggerMode.longPress) {
        Feedback.forLongPress(context);
      } else if (triggerMode == JustTheirTooltipTriggerMode.tap) {
        Feedback.forTap(context);
      } else if (triggerMode == JustTheirTooltipTriggerMode.hover) {
        Feedback.forHover(context);
      } else {
        Feedback.forTap(context);
      }
    }
  ...
  Widget build(BuildContext context) {
    ...
    if (triggerMode == JustTheirTooltipTriggerMode.manual) {
      result = widget.child;
    } else {
      result = GestureDetector(
        ...
        onLongPress: widget.isModal
            ? null
            : (triggerMode == JustTheirTooltipTriggerMode.longPress)
                ? _handlePress
                : null,
        onTap: widget.isModal
            ? _showTooltip
            : (triggerMode == JustTheirTooltipTriggerMode.tap)
                ? _handlePress
                : null,
