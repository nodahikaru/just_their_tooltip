...
import 'package:just_their_tooltip/src/models/just_their_controller.dart';
...
/// {@endtemplate}
abstract class JustTheirInterface extends StatefulWidget {
  const JustTheirInterface({Key? key}) : super(key: key);
  ...
  JustTheirController? get controller;
  ...
  JustTheirTooltipTriggerMode? get triggerMode;
