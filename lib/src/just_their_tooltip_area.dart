...
class InheritedTooltipArea extends InheritedWidget {
  final _JustTheirTooltipAreaState data;
...
class JustTheirTooltipArea extends StatefulWidget {
  final TooltipBuilder builder;

  const JustTheirTooltipArea({Key? key, required this.builder}) : super(key: key);

  /// Used to retrieve the scope of the tooltip. This scope is responsible for
  /// managing the children `JustTheTooltip`s
  static _JustTheirTooltipAreaState of(BuildContext context) {
    final scope =
  ...
  static _JustTheirTooltipAreaState? maybeOf(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<InheritedTooltipArea>();
  ...
  @override
  State<JustTheirTooltipArea> createState() => _JustTheirTooltipAreaState();
}
...
class _JustTheirTooltipAreaState extends State<JustTheirTooltipArea> {
