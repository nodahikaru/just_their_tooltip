part of 'just_their_tooltip.dart';
...
class JustTheirTooltipEntry extends StatefulWidget implements JustTheirInterface {
  const JustTheirTooltipEntry({
    Key? key,
  ...
  @override
  _JustTheirTooltipEntryState createState() => _JustTheirTooltipEntryState();
}

// TODO: I think I want notifications instead... I'm really not sure
// https://stackoverflow.com/a/65854697/8213910
class _JustTheirTooltipEntryState extends _JustTheirTooltipState<Widget> {
  ...
  void _createNewEntries() {
    ...
    final tooltipArea = JustTheirTooltipArea.of(context);
